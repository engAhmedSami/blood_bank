...
//     _initializeGemini();
//     _fetchCurrentUser();
//     _showSessionChoiceDialog(); // استدعاء نافذة الحوار عند بدء الصفحة
//   }
...
//       showDialog(
//         context: context,
//         barrierDismissible: false, // إجبارية
...
//                           _createNewSession(); // بدء جلسة جديدة
//                         },
...
//                       ),
//                     ),
//                     const SizedBox(width: 10), // إضافة مساحة بين الأزرار
//                     Expanded(
//                       child: ElevatedButton.icon(
//                         onPressed: () {
//                           Navigator.pop(context); // إغلاق نافذة الحوار
//                           _showSessionList(); // عرض الجلسات السابقة
//                         },
...
//           TextButton(
//             onPressed: () {
//               Navigator.pop(context); // إغلاق النافذة بدون إنشاء الجلسة
//             },
...
//               // تحقق من أن اسم الجلسة ليس فارغًا
...
//                     _messages.clear(); // تفريغ الرسائل للجلسة الجديدة
//                   });
